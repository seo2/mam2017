                                 ...
                                 <ul class="nav navbar-nav">
                                    ...
                                    <?php }else{ 	?>
                                     <!-- <li><a id="btn_distrito" 		href="<?php bloginfo('url'); ?>/distrito-de-lujo"><?php echo $menu2; ?></a></li> -->
                                      <li><a id="btn_tiendas"     href="<?php bloginfo('url'); ?>/tiendas#tiendas"><?php echo $menu7; ?></a></li>
                                     <li><a id="btn_boulevard" 		href="<?php bloginfo('url'); ?>/patio-de-comidas#patio-de-comidas"><?php echo $menu3; ?></a></li>
                            ...
                            <!--      <div class="faq">
                              ...
                              <div class="horarios">
                                    <ul class="clearfix">
                                      ...
                                      <li>
                                            <a href="https://www.google.cl/maps/place/Mall+Arauco+Maip%C3%BA/@-33.4820447,-70.7510304,15z/data=!4m5!3m4!1s0x0:0xdb6d81fc6e90e4e5!8m2!3d-33.4820447!4d-70.7510304" target="_blank"><i class="fa fa-map-marker" aria-hidden="true"></i><?php echo $tit2; ?> </a>
                                      </li>
                                    </ul>
                              </div>
                            </div>
